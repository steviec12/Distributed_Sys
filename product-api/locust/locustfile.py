"""
Load test for Product API using standard HttpUser.
HttpUser creates a new connection per request (requests library under the hood).

Usage:
  locust -f locustfile.py --host=http://localhost:8080
  locust -f locustfile.py --host=http://<AWS-PUBLIC-IP>:8080
"""
