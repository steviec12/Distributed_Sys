"""
STRESS TEST - No wait time, high concurrency.
This removes the artificial wait_time bottleneck to see true server throughput.

Usage:
  locust -f locustfile_stress.py --host=http://16.144.83.110:8080
"""
